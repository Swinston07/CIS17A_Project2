                    ...
                    do {
                        ...
                        for(int i = 0; i < plyrs; i++){
                            dce.write(reinterpret_cast<char *>
                                     (player[i].getDice()),(dice)*
                                     sizeof(player[i].getDice()));
                        }
                        ...
                        do{
                            ...
                            plCalls.calls12();
                            //cin >> calls.call1 >> calls.call2;
                        }while(plCalls.gCall1() < 1 || plCalls.gCall2() > 6);
                        cout << p1 <<" says " << plCalls.gCall1() << "," << plCalls.gCall2() 
                             << endl;
                        ...
                        do {
                            ...
                            pLiar.inLiar();
                                ...
                                if (pLiar.getLiar() == 'l' || pLiar.getLiar() == 'L') {
                                    isLiar = pLiar.tOrF1(player[0].getDice(), 
                                                         player[1].getDice(),
                                                         dice, plCalls.gCall1(),
                                                         plCalls.gCall2());
                            ...
                            // Code for if Player 2 doesn't call Player 1 a liar
                                    ...
                                    cout << p2 <<" says " << plCalls.gCall3()<< "," 
                                        ...
                                        if (pLiar.getLiar() == 'l' || pLiar.getLiar() 
                                            ...
                                            isLiar = pLiar.tOrF2(player[0].getDice(), 
                                                                 player[1].getDice(), 
                                                                 dice, plCalls.gCall3(),
                                                                 plCalls.gCall4());
                                                    
                                                    //isLiar2(pDce->plyrDce, plyrs, dice,
                                                      //      calls.call3,
                                                      //      calls.call4);
                                            cout << "Play again? Y - Yes "
                                                    "N - No" << endl;
